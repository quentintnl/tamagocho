...
import {useMonsterGeneration} from '@/hooks/useMonsterGeneration'
...
function CreateMonsterForm({onSubmit, onCancel}: CreateMonsterFormProps): React.ReactNode {
    ...
    const {monsterDisplay, generateNewMonster} = useMonsterGeneration()
    ...
    const handleGenerateMonster = (): void => {
        ...
        setFormState(prev => ({
            ...prev,
            draw: monsterDisplay.imagePath,
            state: monsterDisplay.state,
            showPreview: true
        }))
    }
    ...
    const getStateStyles = (state: string): string => {
        ...
        const stateStyles = {
            ...
            angry: 'brightness-100 saturate-150 hue-rotate-[330deg]', // Rouge
            hungry: 'brightness-90 saturate-125 hue-rotate-[45deg]', // Jaune-orange
