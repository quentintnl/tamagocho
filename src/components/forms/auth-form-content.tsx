            ...
            <div className='absolute w-full h-full overflow-hidden pointer-events-none'>
                ...
                <div className='absolute -left-8 top-20 animate-float transform hover:scale-110 transition-transform'>
                    <div className='relative transform -rotate-12'>
                        <Monster name='Mochi' type='happy' level={1}/>
                        <div
                ...
                >
                    <div className='relative transform rotate-6'>
                        <Monster name='Sleepy' level={2} type={"happy"}/>
                ...
                >
                    <div className='relative transform -rotate-6'>
                        <Monster name='Peekaboo' level={3} type={"happy"}/>
                        <div
                        ...
                        >
                            {isSignIn
                                ...
                                : <>Déjà un compte ? Connectez-vous ! <span
                                    className='group-hover:animate-wave inline-block'
                                >👋
                </span>
                                </>}
                        </Button>
